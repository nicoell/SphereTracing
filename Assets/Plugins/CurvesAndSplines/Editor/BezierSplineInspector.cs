...
namespace CurvesAndSplines
{
	...
	public class BezierSplineInspector : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			{
				DrawAllPointsInspector(i);
			}

			if (GUILayout.Button("SelectPreviuos Point"))
			{
		...
		private void DrawAllPointsInspector(int i)
		{
			...
			BezierControlPointMode mode =
				(BezierControlPointMode) EditorGUILayout.EnumPopup("Mode", spline.GetControlPointMode(i));
			if (EditorGUI.EndChangeCheck())
			{
		...
		{
			GUILayout.Label("Active Point "+selectedIndex, EditorStyles.boldLabel);
			EditorGUI.BeginChangeCheck();
